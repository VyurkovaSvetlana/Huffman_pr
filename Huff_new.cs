...
namespace ConsoleApp1
{
    class Program
    {
        ...
        class TreeNode : IComparable<TreeNode>
        {
            ...
            public void getMasks(Bits bits, ref Dictionary<char, Bits> res)
            {
        ...
        static void Main(string[] args)
        {
            ...
            var masks = new Dictionary<char, Bits>();
            orderedList.First().Key.getMasks(null, ref masks);
